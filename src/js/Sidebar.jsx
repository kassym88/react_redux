...
export default class Sidebar extends React.Component{
    ...
    showHide = () => {
        // this.props.sidebarActive = !this.props.sidebarActive;
    };
                        ...
                        <div className="sidebar-sticky">
                            <ul className="nav flex-column">
                                <li className="nav-item" >
                                    <Link to="/" className="nav-link active" onClick={this.props.hideSidebar}>
                                ...
                                <li className="nav-item">
                                    <Link to="/promochart" className="nav-link" onClick={this.props.hideSidebar}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                             fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                             strokeLinejoin="round" className="feather feather-home">
                                            <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                                        ...
                                        Promochart <span className="sr-only">(current)</span>
                                    </Link>
                                </li>
                                <li className="nav-item">
